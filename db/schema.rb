...
ActiveRecord::Schema.define(version: 20160119041109) do
  ...
  create_table "photos", force: :cascade do |t|
    ...
    t.integer  "photo_arrange_order", limit: 4
    t.datetime "created_at",                      null: false
    t.datetime "updated_at",                      null: false
    t.boolean  "photo_main_display"
  end
  ...
  create_table "searches", force: :cascade do |t|
    ...
    t.string   "search_model", limit: 255
    t.string   "search_year",  limit: 255
    t.datetime "created_at",               null: false
    t.datetime "updated_at",               null: false
    t.string   "search_make",  limit: 255
  end
  ...
  create_table "watches", force: :cascade do |t|
    t.integer  "watcher",      limit: 4
    t.integer  "watched_list", limit: 4
